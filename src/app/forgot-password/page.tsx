...
export default async function ForgotPasswordPage({ searchParams }: Readonly<ForgotPasswordPageProps>) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-blue-100 flex flex-col items-center justify-center p-4">
      ...
      <div className="text-center mb-8">
        <div className="flex items-center justify-center gap-2 mb-4">
          <Image src="/assets/images/logo.svg" alt="Mood tracking system" width={178} height={40} priority />
        </div>
      </div>
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form action={handleForgotPassword} className="space-y-6" noValidate>
            {successMessage && (
