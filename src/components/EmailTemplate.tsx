...
interface MoodResetPasswordEmailProps {
...
export const MoodResetPasswordEmail = ({
    userFirstname,
    email,
    resetPasswordLink,
        ...
        <Html>
            ...
            <Body style={main}>
                ...
                <Container style={container}>
                    <Img
                        src={`${baseUrl}/assets/images/email-logo.png`}
                        width="178"
                        height="40"
                        alt="Mood tracking"
                    />
                    <Section>
                        ...
                        <Text style={text}>
                            ...
                            your Mood tracking account. If this was you, you can set a
                            new password here:
                        </Text>
                        ...
                        <Text style={text}>Happy Mood day!</Text>
                    </Section>
                </Container>
            </Body>
        </Html>
...
MoodResetPasswordEmail.PreviewProps = {
    userFirstname: "Chamu",
    resetPasswordLink: "http://preprince.co.za",
} as MoodResetPasswordEmailProps;

export default MoodResetPasswordEmail;
