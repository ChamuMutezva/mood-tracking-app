...
export default function Step2FeelingsSelection({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h4 className="text-preset-5 text-foreground font-medium mb-2">How do you feel?</h4>
        <p className="text-preset-7 text-muted-foreground mb-4">
          Select up to three tags ({selectedFeelings.length}/3 selected)
        </p>
          ...
          {feelingOptions.map((feeling) => {
            ...
            return (
              ...
              >
                ...
                />
                <span
                  className={`text-preset-6 font-medium ${isDisabled ? "text-gray-400" : "text-foreground"}`}
                >
                  {feeling}
                </span>
              </label>
